export const en = {
  ...
  walkInHelp:
    'For someone at the counter or on the phone. It holds the chair like any other appointment, and they need no account.',
  walkInName: 'Name',
  walkInNamePlaceholder: 'Who is it for',
  walkInPhone: 'Phone (optional)',
  walkInPhoneHint: 'Only your salon sees this.',
  walkInWho: 'With',
  walkInAnyone: 'Whoever is free',
  walkInWhen: 'Starts at',
  walkInServices: 'Services',
  walkInNoServices: 'Add a service to your list first — the price comes from it.',
  walkInSave: 'Add booking',
  walkInSaved: 'Booking added ✓',
  walkInBadge: 'Walk-in',
  walkInNeedName: 'A name is needed, so the booking can be found again.',
  walkInNeedService: 'Choose at least one service — the price comes from it.',
  walkInNobodyFree: 'Nobody is free then. Pick another time, or a different specialist.',
  walkInChairTaken: 'That specialist is already booked then.',
  walkInNotAllowed: 'Only the salon’s owner can add a booking.',
  walkInFailed: 'Could not save that. Check your connection and try again.',
